...
* **Strategic Segmentation:** Developed CTEs with CASE WHEN logic to categorize 99k+ transactions into specific age demographics (18-29, 30-39, etc.).

* **Time-Series Analysis:** Utilized FORMAT() and date functions to model monthly sales trends and identify revenue stability.

* **Consumer Behavior:** Analyzed payment method distribution (Cash vs. Credit) and category-based spending patterns.
